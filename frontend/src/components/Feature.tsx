            ...
            <section className="relative" aria-labelledby="Featuretwo" id="features">
                ...
                <div className="relative px-8 lg:px-32 md:px-12 mx-auto max-w-7xl py-12 lg:py-24 space-y-24">
                    <div className="list-none gap-4 grid grid-cols-1 lg:gap-24 lg:grid-cols-2 mt-6">
                        ...
                        <p className="mt-4">
                            <strong>For compute</strong> - lilpad which is a compute network that can be used to run arbitrary compute workload, ml model training in our case.<br />
                            <strong>For model verification</strong> - Starknet, Orion and zkML with the help of Giza SDK.
                        </p>
                    </div>
                    <div className="list-none gap-4 grid grid-cols-1 lg:gap-24 lg:grid-cols-2 mt-6">
                        <p className="max-w-2xl mt-4 text-slate-800 text-lg">
                        ...
                        <p className="mt-4">
                            <strong>For hosting datasets</strong> - Lighthouse onramp and Filecoin IPFS<br />
                            <strong>For encryption and access control</strong> - Lit Protocol and Actions
                        </p>
                    </div>
                    <div className="list-none gap-4 grid grid-cols-1 lg:gap-24 lg:grid-cols-2 mt-6">
                        <p className="max-w-2xl mt-4 text-slate-800 text-lg">
